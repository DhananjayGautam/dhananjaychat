...
String usernameOfTheRoommate, emailOfRoommate,chatRoomId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(MessageActivity.this).load(getIntent().getStringExtra("img_of_roommate")).placeholder(R.drawable.account_image).error(R.drawable.account_image).into(imgToolbar);
